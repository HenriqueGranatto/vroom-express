...
exports.update = async (request, response) =>
{
    ...
    {        
        ...
        await helper.insertInDB("subscriberLog", {event: "update", token: request.params.token, date: (new Date).toLocaleString(), request: request.body})
...
exports.delete = async (request, response) =>
{
    ...
    {        
        ...
        await helper.insertInDB("subscriberLog", {event: "delete", token: request.params.token, date: (new Date).toLocaleString(), request: request.body})
