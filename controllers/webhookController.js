...
exports.select = async (request, response) =>
{
    ...
    catch(e)
    {
        ...
        await helper.insertInDB("subscribersLog", {event: "error", token: request.params.token, date: (new Date).toLocaleString(), request: request.body, errors: e.toString()})
        return
    }
}
...
exports.update = async (request, response) =>
{
    ...
    {        
        ...
        await helper.insertInDB("subscribersLog", {event: "update", token: request.params.token, date: (new Date).toLocaleString(), request: request.body})
...
exports.delete = async (request, response) =>
{
    ...
    {        
        ...
        await helper.insertInDB("subscribersLog", {event: "delete", token: request.params.token, date: (new Date).toLocaleString(), request: request.body})
